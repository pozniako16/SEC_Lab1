...
/**
    ...
    @param file_type: Optional parameter, given, we check if the file has this extension
    @param file_group: Optionnal parameter, given, we check if the file belongs to this group
...
mod tests {
    ...
    #[test]
    fn specify_goup_and_extension_returns_error(){
